...
\fancyfoot[R]{\sffamily Jan 2017 $\vert$
                        Volume \textbf{3} $\vert$
                        Issue \textbf{1}}
\pagestyle{fancy}
\makeatletter
...
\marginpar{
  ...
  {\bfseries Received}  Oct, 16, 2016\\
  {\bfseries Accepted}  Jan, 11, 2017\\
  {\bfseries Published} Jan, 20, 2017\\
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Shifman-2017}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Shifman-2017}{\faGithubAlt~Code repository}
  \end{repobox}
        \hypersetup{urlcolor=blue}
}
